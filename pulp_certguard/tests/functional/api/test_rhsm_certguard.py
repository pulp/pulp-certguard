...
class RHSMChainCACertGuardBase(RHSMCertGuardBase):
    """A base class for all RHSMCertGuard tests with a chain CA file."""
...
class RHSMV3ChainCACertGuardTestCase(RHSMChainCACertGuardBase):
    """Api tests for RHSMCertGard with V3 RHSM Certificates and a CA chain file."""
