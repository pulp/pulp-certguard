...
X509_UNTRUSTED_CLIENT_CERT_FILE_PATH = os.path.join(
    X509_CERTS_BASE_PATH, "untrusted_client.pem"
)
...
RHSM_V1_TWO_VAR_BASE_PATH = (
    "Default_Organization/Library/content/dist/rhel/server/7/7.4/x86_64/os"
)
...
RHSM_V3_ONE_VAR_BASE_PATH = (
    "Default_Organization/Library/content/dist/rhel8/8/x86_64/baseos/os"
)
